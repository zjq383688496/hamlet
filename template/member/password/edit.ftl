	...
	$inputForm.validate({
		rules: {
			currentPassword: {
				required: true,
				remote: {
					url: "check_current_password.action",
					cache: false
				}
			},
			password: {
	...
	<div class="container member">
		...
		<div class="span18 last">
			<div class="input">
				...
				<form id="inputForm" action="update.action" method="post">
					<table class="input">
						<tr>
							<th>
						...
						<tr>
							...
							<td>
								...
								<input type="button" class="button" value="${message("shop.member.back")}" onclick="location.href='../index.action'" />
							</td>
						</tr>
					</table>
				</form>
