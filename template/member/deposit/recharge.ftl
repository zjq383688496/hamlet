	...
	<div class="container member">
		...
		<div class="span18 last">
			<div class="input deposit">
				...
				<form id="inputForm" action="${base}/payment/submit.action" method="post" target="_blank">
					...
					<table class="input">
						...
						<tr>
							...
							<td>
								...
								<input type="button" class="button" value="${message("shop.member.back")}" onclick="location.href='list.action'" />
							</td>
						</tr>
					</table>
				</form>
