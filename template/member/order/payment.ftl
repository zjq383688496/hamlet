...
$().ready(function() {
	...
	$('input[name="payTypeInfo"]').change(function(){
		$('#paymentButton').removeClass('btn-off');
	});
...
<div class="container order">
	<div id="dialog" class="dialog">
		...
		<div>
			<a href="view.action?sn=${order.sn}">完成付款</a>
			<a href="/">遇到问题</a>
		</div>
		...
		<div class="result">
			...
			<div class="result-info">
				<div class="result-total">
					...
					<div class="rt-center" style="display:none">
						<span>支付方式</span>
				...
				<div class="result-content">
					<form id="paymentForm" action="${base}/member/order/paymentSel.action" method="post" target="_blank">
						<input type="hidden" name="type" value="payment" >
						<input type="hidden" name="sn" value="${order.sn}" >
						<div class="title">支付平台</div>
						<ul id="paymentPlugin" class="paymentPlugin_4">
							<li>
								<input type="radio" name="payTypeInfo" id="wexinPay"><a href="javascript:;" style="background-image: url(http://static.hamlet365.com/demo-image/3.0/payment_plugin/alipay.gif);">支付宝即时交易</a>
							</li>
						</ul>
						<!--<div class="title">支持网银</div>
							<ul id="paymentPlugin" class="paymentPlugin_6">
								<li class="selected">
									<a href="javascript:;" style="background-image: url(http://static.hamlet365.com/demo-image/3.0/payment_plugin/alipay.gif);">支付宝即时交易</a>
								</li>
							</ul>
						-->
					</form>
			...
			<a id="paymentButton" class="paymentButton btn-off" href="javascript:;">立即支付</a>
			<span class="result-msg result-error" style="display:none">请选择支付方式</span>
