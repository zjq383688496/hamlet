...
<link href="<@website.static />/resources/shop/css/article.css" rel="stylesheet" type="text/css" />
	...
	<div class="container articleList">
		<div class="span6">
			...
			<div class="articleSearch">
				...
				<div class="content">
					<form id="articleSearchForm" action="${base}/article/search.action" method="get">
		...
		<div class="span18 last">
			...
			<@pagination pageNumber = page.pageNumber totalPages = page.totalPages pattern = "search.action?keyword=${articleKeyword}&pageNumber={pageNumber}">
