...
<title>${message("shop.password.find")}</title>
...
<link href="<@website.static />/resources/shop/css/password.css" rel="stylesheet" type="text/css" />
		...
		<div class="span24">
			<div class="wrap">
				<div class="main">
					...
					<form id="passwordForm" action="find.action" method="post">
