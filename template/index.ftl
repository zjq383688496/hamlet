...
<link href="<@website.static />/resources/shop/slider/slider.css" rel="stylesheet" type="text/css" />
<link href="<@website.static />/resources/shop/css/common.css" rel="stylesheet" type="text/css" />
<link href="<@website.static />/resources/shop/css/index.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="<@website.static />/resources/shop/slider/slider.js"></script>
	...
	<div class="container index">
		...
		<div class="span18">
			<div class="hotBrand clearfix">
				<div class="title">
					<a href="${base}/brand/list/1.action">${message("shop.index.allBrand")}</a>
			...
			<div class="hotProductCategory">
				<div class="title">
					<a href="${base}/product_category.action">${message("shop.index.allProductCategory")}</a>
				...
				<ul class="tab">
					<@promotion_list hasEnded = false count = 2>
						<#list promotions as promotion>
							<li>
								<a href="${base}/product/list.action?promotionId=${promotion.id}" target="_blank">${promotion.name}</a>
							</li>
						</#list>
					</@promotion_list>
				</ul>
			...
			<div id="hotProduct" class="hotProduct clearfix">
				<@product_category_root_list count = 3>
					<div class="title">
						...
						<a href="${base}/product/list.action?tagIds=1" target="_blank"></a>
					</div>
					<ul class="tab">
			...
			<div id="newProduct" class="newProduct clearfix">
				<@product_category_root_list count = 3>
					<div class="title">
						...
						<a href="${base}/product/list.action?tagIds=2" target="_blank"></a>
					</div>
					<ul class="tab">
						<#list productCategories as productCategory>
							<li>
		...
		<div class="span24">
			<div class="friendLink">
				<dl>
					...
					<dd class="more">
						<a href="${base}/friend_link.action">${message("shop.index.more")}</a>
					</dd>
				</dl>
			</div>
		</div>
